...
For our other IDEs and editors like Eclipse, Visual Studio, Neovim, Google Colab, and more, visit [our download page](https://codeium.com/download) to get started.
<Note>Self-hosted functionality for enterprises may differ. If you are an enterprise user, please refer to your enterprise portal.</Note>
<Tabs>
