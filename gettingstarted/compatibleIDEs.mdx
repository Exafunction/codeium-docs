...
**JetBrains IDEs**: Version 2022.3+. Please note we do not support JetBrains Fleet or Resharper.

> JetBrains IDEs with remote SSH support require versions 2023.3+
