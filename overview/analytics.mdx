...
There are a number of settings available for your profile page. This includes:

- Name
- Email (for accounts with email authentication)
- Profile picture
...
You can also change and update your password if you used email & password authentication.
